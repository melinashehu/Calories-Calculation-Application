...
public class UserDAOImplementation implements UserDAO {
        ...
        private DatabaseConnectionInterface connectionInterface;

        public UserDAOImplementation() {
            this.connectionInterface = new DatabaseConnection();
        }

        public UserDAOImplementation(DatabaseConnectionInterface connectionInterface) {
        ...
        public List<User> getAllUsers() { //tested and it works
            ...
            try(Connection conn =(Connection) connectionInterface.getConnection();
